...
.directive('placeholder', function($timeout, $document, $interpolate, placeholderSniffer) {
...
! function(a, b) {
    ...
    if (h.defaults = {}, f(h.prototype, {
            ...
            lines: function(d, f) {
                ...
                }), f.shadow && b(i, e(h("#019FC2", "0 0 4px #019FC2"), {
                    top: "2px"
                })), b(d, b(i, h(g(f.color, k), "0 0 1px rgba(1,159,194,.1)")));
                return d
            },
